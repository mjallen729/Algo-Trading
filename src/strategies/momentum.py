...
class MomentumStrategy(BaseStrategy):
    ...
    def __init__(self, config: Dict = None):
        ...
        logger.info(f"MomentumStrategy initialized with RSI threshold: {self.rsi_threshold}")
    ...
    def _calculate_momentum_score(self, indicators: pd.DataFrame) -> float:
        ...
        macd_strength = abs(latest['MACD_Histogram']) / indicators['MACD_Histogram'].rolling(20).std().iloc[-1]
