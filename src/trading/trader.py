...
class Trader:
    def __init__(self, api_key: str, secret_key: str, base_url: str):
        self.trading_client = TradingClient(api_key, secret_key, paper=True, url_override=base_url)
    ...
    def place_market_order(self, symbol: str, quantity: float, side: str):
        ...
        try:
            ...
            print(f"Successfully placed {side} order for {quantity} of {symbol}. Order ID: {market_order.id}")
            return market_order
